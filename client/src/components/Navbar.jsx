...
const Navbar = ({ isStarter, WhiteTheme }) => {
    ...
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[32px] gap-6">
      ...
      <div className={`lg:flex-1 md:flex-1 flex flex-row max-w-[432px] min-w-[200px] py-2 pl-4 pr-2 h-[52px] ${WhiteTheme ? "bg-[#ffffff] text-black box-shadow-large" : "bg-[#1c1c24] text-white"} rounded-[100px]`}>
        ...
        <div
          ...
          className={`w-[72px] h-full rounded-[20px] ${WhiteTheme ? "bg-[#1dc071]" : "bg-[#116f41]"} flex justify-center items-center cursor-pointer`}
        >
          <img
            src={search}
      ...
      <div className="sm:hidden flex justify-between items-center relative ">
        ...
        <div
          className={`absolute top-[60px] right-0 left-0 ${WhiteTheme ? "bg-[#ffffff]" : "bg-[#1c1c24]" } z-10 shadow-secondary py-4 ${
