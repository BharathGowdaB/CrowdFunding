      ...
      <div className="bg-[#13131a] px-8 py-6 rounded-[12px]">
        ...
        >
          ...
          <div className="relative flex gap-[16px] text-[#808191] text-[18px] text-center">
            ...
            <label
              className={`z-10 flex-1 signup-label ${!form.isStarter && "text-black"}`} onClick={(e) => setForm({ ...form, ["isStarter"]: false })} htmlFor="isStrater-Backer"> Backer</label>
            <div
              className={`z-1 absolute p-4 rounded-[24px] w-[48%] bg-[#1dc071] left-0 transition-[left] duration-700 ${!form.isStarter && "left-[52%]" } `}></div>
          </div>
