...
const Login = ({ setStarterAddress, setBackerAddress }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLogger({
        error: false, message: 'Login Successfully', handleClick: function () {
          navigate('/')
          setIsLogging(false)
        }
      })
  ...
  return (
    ...
    <div className="flex justify-center items-center">
      <div className="w-[55%] h-screen">
        <img
          src="https://cdn.vectorstock.com/i/1000x1000/65/30/rocketship-on-computer-for-startup-media-vector-20786530.webp"
          alt="Background Image"
          className="w-half h-half object-cover absolute top-5 bottom-50 left-20 z-0"
